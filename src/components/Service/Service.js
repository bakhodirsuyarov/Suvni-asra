...
export default function Service() {
  return (
    <div className="services-wrapper ">
      <div className="services flex justify-between items-center py-20  lg:px-48 xl:px-80 sm:px-11">
      ...
      <div className="service-btns flex justify-center items-center">
        <div className="btn-boxes flex items-center">
          <img
            className="absolute  bg-Pblue p-6 rounded-full"
            src={phone}
            alt=""
          />
          <button className="realtive  h-18 bg-white rounded-full py-6 pl-20 pr-28 mr-14">
            <a
        ...
        <div className="btn-boxes flex items-center">
          <img
            ...
            alt=""
          />
          <button className="realtive  h-18 bg-white rounded-full py-6 pl-20 pr-28">
            <a className="text-black text-base font-semibold" href="#!">
              Toshkent sh.
            </a>
          </button>
        </div>
